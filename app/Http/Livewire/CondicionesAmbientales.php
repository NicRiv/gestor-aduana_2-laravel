...
class CondicionesAmbientales extends Component
{
    ...
    {
        $ambientes = Ambientes::where('nombre', 'like', '%'.$this->search.'%')
        ...
        return view('livewire.condiciones-ambientales', compact('ambientes'));
    }
}
