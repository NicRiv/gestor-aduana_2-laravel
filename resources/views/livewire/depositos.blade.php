<div>
    ...
    <div class="flex justify-between px-5 py-5 bg-slate-200">
        <div class="flex items-center justify-start gap-x-2">
            <h4 class="font-medium leading-tight text-2xl mt-0 mb-2">Depósitos</h4>
        </div>
                    ...
                    <tbody>
                        @foreach ($lugardeposito as $lugar)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="block text-center {{ $lugar['activo'] ? 'block px-2 bg-lime-400 text-white' : '' }}">
                                        {{ $lugar['activo'] ? 'Si' : 'No' }}
                                    </span>
                                </td>
                            </tr>
