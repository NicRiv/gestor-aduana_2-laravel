<div>
    ...
    <div class="flex justify-between px-5 py-5 bg-slate-200">
        <div class="flex items-center justify-start gap-x-2">
            <h4 class="font-medium leading-tight text-2xl mt-0 mb-2">Unidades Logísticas</h4>
        </div>
        <div class="flex items-center gap-x-4">
            <x-jet-secondary-button>
                Lista
            </x-jet-secondary-button>
            @can('Crear Unidad Logística')
                    ...
                    <tbody>
                        @foreach ($unidades as $unidad)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="block text-center {{ $unidad['activo'] ? 'block px-2 bg-lime-400 text-white' : '' }}">
                                        {{ $unidad['activo'] ? 'Si' : 'No' }}
                                    </span>
                                </td>
                            </tr>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <select class="mx-2" wire:model="tipo">
                    ...
                    <option value="Unidad de Traslado">Unidad de Traslado</option>
                </select>
                {{-- Mensaje de error --}}
